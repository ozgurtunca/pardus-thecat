...
function pardus_custom_settings() {
  ...
  // Sidebar 
  add_settings_section( 'pardus-sidebar-profile-options', 'Sidebar Profile Options', 'pardus_sidebar_profile_options', 'pardus_thecat');
  // Theme options
  add_settings_section( 'pardus-theme-options', 'Theme Options', 'pardus_theme_options', 'pardus_theme');
  // Contact Form
  add_settings_section( 'pardus-contact-section', 'Contact Form', 'pardus_contact_section', 'pardus_theme_contact');
  // Contact Form
  add_settings_section( 'pardus-portfolio-section', 'Portfolio', 'pardus_portfolio_section', 'pardus_portfolio_activation');
  // Custom CSS
  add_settings_section( 'pardus-custom-css-section', 'Custom CSS', 'pardus_custom_css_section', 'pardus_custom_css_slug');

  // Settngs fields
  // add_settings_field( $id, $title, $callback, $page, $section = 'default', array $args = array() )
  // Sidebar
  add_settings_field( 'sidebar-profile-image', 'Profile Image', 'pardus_sidebar_profile_image', 'pardus_thecat', 'pardus-sidebar-profile-options' );
  add_settings_field( 'sidebar-name', 'Full Name', 'pardus_sidebar_name', 'pardus_thecat', 'pardus-sidebar-profile-options' );
  add_settings_field( 'sidebar-description', 'Description', 'pardus_sidebar_description', 'pardus_thecat', 'pardus-sidebar-profile-options' );
  add_settings_field( 'sidebar-twitter', 'Twitter', 'pardus_sidebar_twitter', 'pardus_thecat', 'pardus-sidebar-profile-options' );
  add_settings_field( 'sidebar-facebook', 'Facevook', 'pardus_sidebar_facebook', 'pardus_thecat', 'pardus-sidebar-profile-options' );
  add_settings_field( 'sidebar-instagram', 'Instagram', 'pardus_sidebar_instagram', 'pardus_thecat', 'pardus-sidebar-profile-options' );
  // Theme options
  add_settings_field( 'post-formats', 'Post Formats', 'pardus_post_formats', 'pardus_theme', 'pardus-theme-options' );
  add_settings_field( 'custom-header', 'Custom Header', 'pardus_custom_header', 'pardus_theme', 'pardus-theme-options' );
  add_settings_field( 'custom-background', 'Custom Background Image', 'pardus_custom_background', 'pardus_theme', 'pardus-theme-options' );
  // Contact form options
  add_settings_field( 'activate-form', 'Activate Contact Form', 'pardus_activate_contact', 'pardus_theme_contact', 'pardus-contact-section' );
  add_settings_field( 'activate-portfolio', 'Activate Portfolio Post Type', 'pardus_theme_portfolio', 'pardus_portfolio_activation', 'pardus-portfolio-section' );
  // Custom CSS
  add_settings_field( 'thecat-custom-css', 'Insert Custom CSS', 'pardus_custom_css_callback', 'pardus_custom_css_slug', 'pardus-custom-css-section' );
} 
...
function pardus_sidebar_profile_options() {
  echo "Customize Sidebar Profile Options";
}
// Theme supoort page description
function pardus_theme_options(){
  echo "Activate and Deavtivate Specific Theme Support Options";
}
...
function pardus_portfolio_section(){
   echo "Activate and Deactivate Portfolio Post Type";
}
// Custom Css description
function pardus_custom_css_section(){
  echo "Insert Your Custom CSS";
}
...
function pardus_sidebar_description() {
  ...
  echo '
  <input type="text" name="user_description" placeholder="Briefly about yourself" value="' . $description . '">
  ';
}
...
function pardus_sidebar_twitter(){
  ...
  echo '
    <input type="text" name="twitter_handler" placeholder="Twitter handler" value="' . $twitter . '">
...
function pardus_sidebar_facebook(){
  ...
  echo '
    <input type="text" name="facebook_handler" placeholder="Facebook handler" value="' . $facebook . '">
  ';
}
...
function pardus_sidebar_instagram(){
  ...
  echo '
    <input type="text" name="instagram_handler" placeholder="Instagram handler" value="' . $twitter . '">
