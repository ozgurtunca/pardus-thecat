...
function mytheme_kirki_sections( $wp_customize ) {
	...
	$wp_customize->add_panel( 'backgrounds', array(
		'priority'    => 10,
		'title'       => esc_html__( 'Backgrounds', 'kirki' ),
	) );
	 ...
	 */
     $wp_customize->add_section( 'header_background', array(
 		'title'       => esc_html__( 'Header Background', 'kirki' ),
 		'priority'    => 10,
 		'panel'       => 'backgrounds',
 	) );
     ...
     $wp_customize->add_section( 'main_background', array(
 		'title'       => esc_html__( 'Main Background', 'kirki' ),
 		'priority'    => 20,
 		'panel'       => 'backgrounds',
 	) );

     $wp_customize->add_section( 'footer_background', array(
 		'title'       => esc_html__( 'Footer Background', 'kirki' ),
 		'priority'    => 30,
 		'panel'       => 'backgrounds',
 	) );
